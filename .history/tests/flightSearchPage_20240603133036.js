...
class FlightSearchPage {
  ...
  async clickContinue() {
    ...
    await this.continueButton.waitFor({ state: 'visible', timeout: 90000000000 }); // Wait until the button is visible
    await this.continueButton.waitFor({ state: 'enabled', timeout: 90000000000 }); // Wait until the button is enabled
