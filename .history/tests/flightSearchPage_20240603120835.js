...
class FlightSearchPage {
  ...
  async selectFlight() {
    // Wait for the itinerary selection page to load
    await this.page.waitForSelector('text="Thursday 06 June 2024"');

    // Locate and select the desired flight option
    await this.page.click('text="Thursday 06 June 2024"');

    // Click on the "seat" option
    await this.page.click('text="seat"');
