...
test.describe('Air New Zealand Flight Booking', () => {
  ...
  test('Test Case 1: Verify flight search functionality', async ({ page }) => {
    ...
    await page.fill('#From', 'Auckland');  // Adjust selector to match actual field ID
    await page.fill('#To', 'Wellington');  // Adjust selector to match actual field ID
    await page.fill('#', '2024-06-15');  // Adjust selector to match actual field ID
