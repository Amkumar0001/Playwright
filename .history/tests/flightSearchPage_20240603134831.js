...
class FlightSearchPage {
  ...
  async clickContinue() {
    ...
    await continueButton.waitFor({ state: 'visible', timeout: 100000 }); // Wait until the button is visible
    await continueButton.waitFor({ state: 'enabled', timeout: 10000 }); // Wait until the button is enabled
